...
function Cards() {
  ...
  const cardsData = [
    { src: 'images/react.png', text: 'Personal Portfolio (React JS)', label: 'Personal', link: '/', pic: 'images/react.png', buttonText: 'Go to website', details: 'Developed a dynamic and responsive personal portfolio website using React.js. This project showcases my professional journey, skills, and accomplishments in a user-friendly and visually appealing manner. Utilizing React.js, I implemented smooth navigation, interactive elements, and a modern design to enhance user engagement.' },
    ...
    { src: 'images/ragam.png', text: 'Registration Head, Ragam', label: 'NITC', link: 'https://ragam.co.in/', pic: 'images/ragam.png', buttonText: 'Go to website', details: 'As the Registration Head for Ragam 2020, the annual cultural fest of the National Institute of Technology, Calicut, I led a team of over 50 members in managing event registrations and financial operations. Ragam is one of South India’s largest cultural fests, attracting around 80,000 attendees. My role involved coordinating the registration process, ensuring seamless participant experience, and overseeing the financial management to maintain budgetary discipline. This experience honed my leadership and organizational skills, and my ability to handle large-scale events efficiently.' },
    { src: 'images/clubmath.png', text: 'Senior Executive, Club Mathematica', label: 'NITC', link: 'https://clubmathematica.com/', pic: 'images/clubmath.png', buttonText: 'Go to website', details: 'As a Senior Executive of Club Mathematica, the technical club at the National Institute of Technology, Calicut, I played a pivotal role in organizing Infinitum, a state-level logical quizzing event that engaged approximately 15,000 participants. I led a 25-member team, secured 20% sponsorship from a prestigious educational institution, and worked closely with the marketing team to ensure the event’s success. Additionally, I coordinated registration for Locus’19, the annual math-based summit, enhancing its prominence and participation. This position developed my event management, sponsorship negotiation, and teamwork skills.' },
  ];
